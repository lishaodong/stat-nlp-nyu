...
class EmpiricalBigramLanguageModel implements LanguageModel {
	...
	public EmpiricalBigramLanguageModel(
      ...
      System.out.println(wordCounter.getCount("gas"));
      System.out.println(wordCounter.getCount("s."));
      System.out.println(bigramCounter.getCount("shipping", "gas"));
      System.out.println(bigramCounter.getCount("gas", "oil"));
      System.out.println(bigramCounter.getCount("shipping","s."));
      System.out.println(bigramCounter.getCount("s.", "oil"));
    }
